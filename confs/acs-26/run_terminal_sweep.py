"""
Terminal-sweep experiment: varies the lexicon size of TEST_GRAMMAR_MED
...
Usage:
    python confs/acs-26/run_terminal_sweep.py
"""
...
OUT_BASE  = os.path.join(_HERE, "terminal_sweep")
...
def main():
    ...
    print(f"=== Terminal sweep — generating datasets (one per variant) ===")
    grammars = {}
    corpora  = {}
    n_terminals = {}
    ...
    print(f"\n=== Terminal sweep — {len(SEEDS)} seeds × {len(grammars)} variants "
