...
Goal is to analyze the construction of partial parse trees through different scoring functions.
Need to appropriately justify the choices we make through printing.
"""
...
for i, doc in enumerate(train_documents):
    ...
    if i % 5 == 0:
        parse_tree.visualize(f"tests/gen_learn_test/train_trees/train_parse_tree{i}")
